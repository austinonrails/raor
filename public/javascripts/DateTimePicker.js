...
Ext.ux.touch.DateTimePicker = Ext.extend(Ext.Picker, {
   ...
   */
  slotOrder: ['month', 'day', 'hour', 'minute', 'daynight'],

  constructor: function(config) {
    if(config == undefined) config = {};
    if(config.showYears) Ext.apply(config, {slotOrder: ['month', 'day', 'year', 'hour', 'minute', 'daynight']});
    Ext.ux.touch.DateTimePicker.superclass.constructor.call(this, config);
  },
  ...
  initComponent: function() {
    ...
    if ( this.showYears ) {
      this.showYears = ['month', 'day', 'year', 'hour', 'minute', 'daynight'];
